    ...
    chapters     = {
        ...
        {   chapter    = 2,
            ...
            verses = {
                {   verse = 1,
                    ...
                    "and for those who are at Laodicea, and for all those who have not personally seen my face,",
                },
                {   verse = 2,
                ...
                {   verse = 22,
                    "(which all refer to things destined to perish with use)—",
        ...
        {   chapter    = 4,
            ...
            verses = {
                ...
                {   verse = 9,
                    "and with him Onesimus, our faithful and beloved brother, who is one of your number.",
