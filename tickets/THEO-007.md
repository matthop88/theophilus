...
### Description:
The Bible Application takes in input just like THEO-006, but the display is much cleaner:

Given: love . Philippians 1:1-6 "NASB 95"
...
General requests are adjusted to be as specific as possible.
